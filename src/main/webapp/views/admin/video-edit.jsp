...
<div class="container mt-5">
    ...
    <form action="${pageContext.request.contextPath}/admin/video/update" method="post" enctype="multipart/form-data" class="row g-3">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control text-center" id="cateID" name="cateID" readonly value="${category.categoryid}">
        </div>

        <!-- Video ID (readonly) -->
        <div class="col-md-6">
            <label for="videoid" class="form-label">Video ID:</label>
            <input type="text" class="form-control text-center" id="videoid" name="videoid" readonly value="${vId.videoId}">
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="file" class="form-control" id="images" name="images" value="${vId.poster}">
        </div>
        ...
        <div class="col-md-12">
            ...
            <textarea class="form-control" id="description" name="description" rows="3">${vId.description}</textarea>
        </div>

        <!-- Views -->
        <div class="col-md-6">
            <label for="views" class="form-label">Views:</label>
            <input type="number" class="form-control" id="views" name="views" value="${vId.views}">
        </div>

        <!-- Active status (readonly) -->
        <div class="col-md-6">
            <label for="active" class="form-label">Active:</label>
            <input type="text" class="form-control text-center" id="active" name="active" value="${category.status}" readonly>
        </div>
